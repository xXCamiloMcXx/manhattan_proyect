...
public class Evento {
    ...
    public Evento(DatosRegistroEvento datosRegistroEvento) {
        ...
        this.categoria = datosRegistroEvento.categoria();
        this.frasePromocional = datosRegistroEvento.frasePromocional();
        this.precio = datosRegistroEvento.precio();
    ...
    public void eliminar(){
        this.activo = false;
        this.estadoEvento = EstadoEvento.ELIMINADO;
    }
